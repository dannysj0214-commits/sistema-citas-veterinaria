      ...
      <body>
        <div class="historia-container">
          <div class="header">
            ...
            <div class="contacto">
              Tel: ${vetData.telefono} | Email: ${vetData.email} | ${vetData.direccion}
            </div>
          </div>
          <div class="titulo">
          ...
          <div class="seccion">
            ...
            <table class="tabla-datos">
              <tr><td class="label">Nombre:</td><td class="valor">${vetData.nombre}</td><td class="label">Título:</td><td class="valor">${vetData.titulo}</td></tr>
              <tr><td class="label">Registro Médico:</td><td class="valor" colspan="3">${vetData.registro}</td></tr>
            </table>
          </div>
          <div class="firmas">
            ...
            <div class="firma"><div class="linea">_________________________</div><div class="texto">Firma y Sello del Veterinario</div><div class="cc">${vetData.nombre}</div><div class="cc">Registro: ${vetData.registro}</div></div>
          </div>
          <div class="footer">
    ...
    <Container fluid>
      ...
      <div className="historia-container" style={{ 
        ...
        <div className="seccion" style={{ marginBottom: '20px', border: '1px solid #ddd', borderRadius: '5px', overflow: 'hidden' }}>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <tbody>
              <tr><td style={{ width: '25%', padding: '8px 12px', fontWeight: 'bold', background: '#f9f9f9' }}>Nombre:</td><td style={{ width: '75%', padding: '8px 12px' }} colSpan="3">{vetData.nombre}</td></tr>
              <tr><td style={{ padding: '8px 12px', fontWeight: 'bold', background: '#f9f9f9' }}>Título:</td><td style={{ padding: '8px 12px' }}>{vetData.titulo}</td><td style={{ padding: '8px 12px', fontWeight: 'bold', background: '#f9f9f9' }}>Registro Médico:</td><td style={{ padding: '8px 12px' }}>{vetData.registro}</td></tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="firmas" style={{ display: 'flex', justifyContent: 'space-between', marginTop: '40px', paddingTop: '20px', borderTop: '1px solid #ddd' }}>
          ...
          <div style={{ textAlign: 'center', width: '45%' }}>
            ...
            <div style={{ fontSize: '10px', color: '#555' }}>{vetData.nombre}</div>
            <div style={{ fontSize: '10px', color: '#555' }}>Registro: {vetData.registro}</div>
          </div>
        </div>
